...
def induce_clusters(train_path: str, k: int = 256, min_freq: int = 5,
    ...
    cluster map (and the features built from it) reproduce exactly. Returns {word: cluster_id};
    words below min_freq get no entry (treated as the OOV-cluster bucket -1 by iter_features)."""
